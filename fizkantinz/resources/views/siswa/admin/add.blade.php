...
<div class="indicators">
    <div>
        <p class="h1">Siswa</p>
        <p class="h5">Siswa / <a href="#">tambahSiswa</a></p>
    </div>
</div>
                    ...
                    <form method="POST" action="{{ url('siswa/simpanSiswa') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-3">
                                ...
                                <input type="number" class="form-control{{ $errors->has('NIS') ? ' is-invalid' : '' }}" id="NIS" placeholder="NIS" required name="NIS">
                            </div>
                            <div class="form-group col-9">
                                <label for="Nama">Nama</label>
                                <input type="text" class="form-control{{ $errors->has('Nama') ? ' is-invalid' : '' }}" id="Nama" placeholder="Nama" required="" name="Nama">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-3">
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="date" class="form-control{{ $errors->has('Tanggal Lahir') ? ' is-invalid' : '' }}" id="Tanggal_lahir" placeholder="Tanggal Lahir" required="" name="Tanggal_lahir">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-3">
                            ...
                            <div class="form-group col-9">
                                ...
                                <textarea class="form-control{{ $errors->has('Alamat') ? ' is-invalid' : '' }}" name="Alamat" id="Alamat" placeholder="Alamat" required style="height: 110px;"></textarea>
                            </div>
                        </div>
